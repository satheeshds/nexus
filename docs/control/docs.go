// Package control Code generated by swaggo/swag. DO NOT EDIT
package control
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/control.loginRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/control.registerRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "control.loginRequest": {
            ...
            "properties": {
                ...
                "password": {
                    "description": "Customer login password (same value used during registration)",
                    "type": "string"
                }
            }
        },
        "control.registerRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
                ...
                "password": {
                    "description": "Required: customer login password",
                    "type": "string"
                }
            }
        }
