...
// This file contains tests for the handleAdminQuery endpoint.
// It uses package-internal types (Server, adminQueryResponse, tenantQueryResult)
// so must live in package "control" rather than "control_test".
